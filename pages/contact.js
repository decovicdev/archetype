  ...
  const handleSubmit = (e) => {
    ...
    setError({
      ...
      website:
        website.length > 0
          ? isWebsite === false
            ? "Invalid Website (ex: http://google.com or google.com)"
            : ""
          : "",
      selectOption: selectOption.length === 0 ? "Choose Stack" : "",
    });
    let interest = [];
    list.filter((el) => {
      if (el.isActive === true) {
  ...
  return (
    <div className="relative overflow-hidden bg-fullscreencover bg-cover pb-8">
      ...
      <div>
        <Popover
          as="header"
          className="relative overflow-hidden bg-fullscreencover bg-cover pb-8"
        >
          <div className="pt-6">
            <nav
              ...
              >
                <div className="flex flex-col sm:w-full md:w-2/4">
                  ...
                  <div className="flex flex-col w-full h-auto mt-10">
                    ...
                    <div
                      className={
                        error.selectOption.length > 0 &&
                        selectOption.length === 0
                          ? "flex flex-col w-full mt-2 cursor-pointer border border-red-500"
                          : isOption === true
                  ...
                  <span
                    className={
                      error.selectOption.length > 0 && selectOption.length === 0
                ...
                <div className="flex flex-col sm:w-full md:w-2/4">
                  ...
                  <div
                    ...
                    role="alert"
                  >
                    {alert.statusText.length > 0 ? "Awesome! We'll get in touch soon." : "Awesome! We'll get in touch soon."}
          ...
          <div className="container flex flex-col mx-auto py-20 opacity-0">
            <div className="grid grid-cols-3 grid-flow-row gap-5 animate-fade-in-down">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm mt-3">
                  We’re transforming a massive industry. It’s not easy, but it’s
                  a good time and the perfect place to challenge your abilities.
                </p>
              </div>
            </div>
          </div>
