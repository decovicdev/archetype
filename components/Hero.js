...
export default function Hero() {
  ...
  return (
    <div className="relative overflow-hidden bg-fullscreencover bg-cover">
      ...
      <div className="pt-10 lg:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden">
        <div className="mx-auto max-w-7xl lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <div className="mx-auto max-w-md px-4 lg:max-w-2xl lg:px-6 lg:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
              <div className="lg:py-24">
                <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white lg:mt-5 lg:text-6xl lg:mt-6 xl:text-6xl">
                  <span className="block">
                    Generate revenue from APIs in minutes.
                  </span>
                  <span className="block text-[#09E4A8]"></span>
                </h1>
                <p className="mt-3 text-base text-gray-300 lg:mt-5 lg:text-xl lg:text-lg xl:text-xl">
                  Archetype helps APIs launch, iterate, and scale paid business
                  models, with billing infrastructure that works at any size and
                  stage.
                </p>
                <div className="mt-10 lg:flex lg:justify-center lg:justify-start">
