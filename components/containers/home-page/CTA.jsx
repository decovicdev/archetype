...
const CTA = () => {
  return (
    <Container id="cta" className="md:mt-20 px-0 md:px-10 lg:px-5">
      <VStack className="bg-white md:rounded-3xl bg-no-repeat gap-8 bg-cover h-[362px] bg-cta md:bg-cta-xl lg:bg-cta-2xl items-center justify-center relative">
